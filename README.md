...
9. ERROR: Invalid argument '--TMP_DIR'. Can be solved by addition of below command in slurm generated by pipepline:
```export _JAVA_OPTIONS=-Djava.io.tmpdir=/scratch/ss11645/LC/SRA/prefetchData/sra/wags2/DTA/download_data/out/.fastq/ShetlandSheepDog/ERR11203059/.tmp```

10. Other methods of gzip can be:
```
interact -c 4 --mem 16gb
cd /scratch/ss11645/LC/SRA/prefetchData/sra/download_data
gzip -v -t ERR11203059_1.fastq.gz
gzip -v -t ERR11203059_2.fastq.gz
```
